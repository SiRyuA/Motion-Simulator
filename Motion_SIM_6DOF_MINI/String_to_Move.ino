...
void String_to_Axis() {
  ...
  if((char_Temp_1[0] == 'L') || (char_Temp_1[0] == 'l') || (char_Temp_2[0] == 'L') || (char_Temp_2[0] == 'l') || (char_Temp_3[0] == 'L') || (char_Temp_3[0] == 'l')) {
    ...
    Axis_Data[Motor_L1] = map(Axis_Temp[Motor_L], Axis_Min, Axis_Max, Motor_Max, Motor_Min);
    Axis_Data[Motor_L2] = map(Axis_Temp[Motor_L], Axis_Min, Axis_Max, Motor_Min, Motor_Max);
  }
  ...
  if((char_Temp_1[0] == 'R') || (char_Temp_1[0] == 'r') || (char_Temp_2[0] == 'R') || (char_Temp_2[0] == 'r') || (char_Temp_3[0] == 'R') || (char_Temp_3[0] == 'r')) {
    ...
    Axis_Data[Motor_R1] = map(Axis_Temp[Motor_R], Axis_Min, Axis_Max, Motor_Max, Motor_Min);
    Axis_Data[Motor_R2] = map(Axis_Temp[Motor_R], Axis_Min, Axis_Max, Motor_Min, Motor_Max);
  }
  ...
  if((char_Temp_1[0] == 'C') || (char_Temp_1[0] == 'c') || (char_Temp_2[0] == 'C') || (char_Temp_2[0] == 'c') || (char_Temp_3[0] == 'C') || (char_Temp_3[0] == 'c')) {
    ...
    Axis_Data[Motor_C1] = map(Axis_Temp[Motor_C], Axis_Min, Axis_Max, Motor_Max, Motor_Min);
    Axis_Data[Motor_C2] = map(Axis_Temp[Motor_C], Axis_Min, Axis_Max, Motor_Min, Motor_Max);
  }
}

// String work, Command
void String_to_Command() {
  if((VISA_Read == "U") || (VISA_Read == "u")) Servo_FULL_UP();
  if((VISA_Read == "D") || (VISA_Read == "d")) Servo_FULL_DOWN();
  if((VISA_Read == "S") || (VISA_Read == "s")) Servo_START();
  if((VISA_Read == "X") || (VISA_Read == "x")) Servo_RESET(0);
}
